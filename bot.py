...
# Файлы прайсов
price_files = {
    "man": ("👔 Пошив мужской одежды", "пошив мужской одежды.pdf"),
    "woman": ("👗 Пошив женской одежды", "пошив женской одежды.pdf"),
    "man_premium": ("🧥 Премиум пошив мужской одежды", "пошив мужской одежды премиум.pdf"),
    "woman_premium": ("💃 Премиум пошив женской одежды", "пошив женской одежды премиум.pdf"),
    "repair": ("🧵 Ремонт и подгонка", "ремонт и подгонка по фигуре.pdf")
}
